...
# ary = np.load("../data/characters.npz")
# 
# imageList = ary['imageList2']
...
img = Image.fromarray(inputary)
img.show()
print(inputary)
inputary = np.expand_dims(inputary, axis=0)
inputary = inputary.reshape((1, img_rows, img_cols, 1))

# prediction = loaded_model.predict(inputary)
# print(prediction)
# prediction = loaded_model.predict_proba(inputary)
# print(prediction)
